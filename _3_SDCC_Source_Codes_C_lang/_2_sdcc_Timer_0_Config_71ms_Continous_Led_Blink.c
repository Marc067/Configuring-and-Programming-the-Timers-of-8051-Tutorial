...
// Timer 0 is Configured to Generate time delay of 71.1 ms continously
// and blink the LED connected to P3.1 with delay of 71.1 ms (14 times /Second)
...
// Compiler used is SDCC

#include <8052.h>   //Header file used by sdcc
void main(void)
{
  ...
  // Delay = 71.1 mS (milli seconds) 
	...
	while(1)
	{
	  ...
	  TR0 = 0;      // Stop the Timer 
		...
		P3 ^= 0x01; //Toggle P3.1 Bit  using XOR operative
